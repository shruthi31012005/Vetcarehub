...
const DiseasePrediction = () => {
  ...
  useEffect(() => {
    api.get("/animals/")
      ...
      .catch((err) => console.log("Animals load error:", err));
  }, []);
  ...
  const handleAnalyze = async () => {
    ...
    // Quick analysis
      ...
      formData.append("animal_category", category);
    }
    ...
    try {
      ...
      navigate("/vet/prediction-result", {
        state: { result: res.data }
      });

    } catch (err) {

      console.log("Prediction Error:", err.response?.data || err);
