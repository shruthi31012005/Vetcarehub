...
const HealthRecords = () => {
  ...
  useEffect(() => {
    api.get("/predictions/vet/health-records/")
      .then((res) => {
        setRecords(res.data);
      ...
      <div className="relative border-l-2 border-gray-300 pl-6 space-y-8">
        ...
        {filtered.map((record) => (
          <div
            ...
            onClick={() => navigate(`/owner/health-records/${record.id}`)}
          >
            ...
            <div className="bg-white p-5 rounded-xl shadow hover:shadow-lg transition">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className={`px-3 py-1 text-xs rounded-full ${severityColor(record.severity)}`}>
                  {record.severity}
                </span>
